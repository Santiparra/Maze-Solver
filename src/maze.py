...
class Maze:
  ...
  def _solve_r(self, i, j):
    ...
    if (
      i > 0 and not 
      self.cells[i][j].has_left_wall and not 
      self.cells[i - 1][j].visited
    ):
    ...
    if (
      i < self.num_cols - 1 and not 
      self.cells[i][j].has_right_wall and not 
      self.cells[i + 1][j].visited
    ):
      self.cells[i][j].draw_move(self.cells[i + 1][j])
      if self._solve_r(i + 1, j):
    ...
    if (
      j > 0 and not 
      self.cells[i][j].has_top_wall and not 
      self.cells[i][j - 1].visited
    ):
    ...
    if (
      j < self.num_rows - 1 and not 
      self.cells[i][j].has_bottom_wall and not 
      self.cells[i][j + 1].visited
    ):
      self.cells[i][j].draw_move(self.cells[i][j + 1])
      if self._solve_r(i, j + 1):
